...
var app = {
   ...
   findStudent: function(id, successCallback) {
       var url = "http://192.168.43.131:3000/api/Students?filter=%7B%22where%22%3A%7B%22card_id%22%3A%22" + id + "%22%7D%7D";
       $.ajax({
           url: url,
    ...
    onNonNdef: function(nfcEvent) {
        ...
        app.hide(document.getElementById('home'));
        app.findStudent(app.id, app.printStudent);
    },
